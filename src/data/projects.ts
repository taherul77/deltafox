export const projects = [
  {
    ...
    description: 'A full-featured, scalable e-commerce solution supporting B2C and B2B operations with AI-powered recommendations and advanced inventory management.',
    client: {
      name: 'Soft IT Group',
    ...
    teamSize: 15,
    technologies: ['React', 'Node.js', 'MongoDB', 'Redis', 'AWS', 'Stripe API', 'PayPal SDK'],
    ...
    awards: ['2022 Webby Award for Best Shopping Platform', '2023 Retail Tech Innovation Award']
  },
  {
    id: 'fitness-tracker',
    ...
    description: 'Comprehensive health platform combining wearable integration, nutrition planning, and personalized coaching with computer vision form analysis.',
    client: {
      name: 'Healthify Inc.',
    ...
    teamSize: 8,
    technologies: ['Flutter', 'Firebase', 'TensorFlow Lite', 'HealthKit', 'Google Fit API', 'WebRTC'],
    ...
    partnerships: ['Fitbit', 'MyFitnessPal', 'Headspace', 'WHO Healthy Cities Initiative']
  },
  {
    ...
    description: 'Next-generation financial dashboard unifying personal banking, investment, and financial planning with predictive cash flow analysis.',
    client: {
  ...
  },
  {
    ...
    description: 'End-to-end data orchestration platform with AI-assisted insights, automated reporting, and what-if scenario modeling for enterprise decision making.',
    client: {
      name: 'Analytics Pro',
    ...
    teamSize: 20,
    technologies: ['Apache Spark', 'Kubernetes', 'TensorFlow', 'Snowflake', 'Airflow', 'Tableau'],
    ...
    caseStudy: {
      ...
      results: 'Optimized supply chain reducing inventory costs by 18% while improving stock availability'
    }
  },
  {
    ...
    description: 'Adaptive learning ecosystem combining microlearning, VR classrooms, and competency-based progression with blockchain credentialing.',
    client: {
    ...
    teamSize: 18,
    technologies: ['MERN Stack', 'WebRTC', 'Unity', 'Hyperledger', 'WebAssembly', 'LTI'],
  ...
  },
  {
    ...
    description: 'Concierge-level food delivery service featuring Michelin-starred restaurants, live chef streaming, and sustainable packaging tracking.',
    client: {
      name: 'Foodie Inc.',
    ...
    teamSize: 10,
    technologies: ['SwiftUI', 'Jetpack Compose', 'Firebase', 'Mapbox', 'WebSockets', 'Computer Vision'],
    location: 'Singapore',
    budget: '$1.8M',
    problems: [
