...
const PricingPlan: React.FC<PricingPlanProps> = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className={`relative rounded-xl overflow-hidden transition-all duration-300 h-full ${isPopular
        ...
        <div className="p-8">
          ...
          <button className={`w-full py-3 px-6 rounded-md font-semibold transition-colors duration-300 ${isPopular
