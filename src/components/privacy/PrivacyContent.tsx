        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 text-gray-300">
            <div>
              ...
              <p>This Privacy Policy explains how deltaFox (&rdquo;we,&#34; &#34;us,&#34; or &#34;our&rdquo;) collects, uses, and discloses information about you. This Privacy Policy applies when you use our websites, mobile applications, and other online products and services that link to this Privacy Policy (collectively, our &rdquo;Services&rdquo;), contact our customer service team, engage with us on social media, or otherwise interact with us.</p>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>Communicate with you about products, services, and events offered by Delta Fox and others and provide news and information that we think will interest you;</li>
                <li>Monitor and analyze trends, usage, and activities in connection with our Services;</li>
                <li>Detect, investigate, and prevent security incidents and other malicious, deceptive, fraudulent, or illegal activity and protect the rights and property of deltaFox and others;</li>
            ...
            <div>
              ...
              <p>You may opt out of receiving promotional emails from deltaFox by following the instructions in those communications. If you opt out, we may still send you non-promotional emails, such as those about your account or our ongoing business relations.</p>
            </div>

            <div>
              <h2 className="text-xl font-bold text-white mb-4">5. Contact Us</h2>
              <p>If you have any questions about this Privacy Policy, please contact us at:</p>
              <p className="mt-4">deltaFox<br />123 Main Street<br />New York, NY 10001<br />Email: privacy@deltaFoxexample.com<br />Phone: (123) 456-7890</p>
            </div>
          </div>
        </div>
      </div>
