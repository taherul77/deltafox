        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 text-gray-300">
            <div>
              ...
              <p>Our website address is: http://deltaFoxexample.com</p>
            </div>

            <div>
              <div className="bg-white/5 p-6 rounded-xl mb-6">
                <p>We collect certain data from you directly, like information you enter yourself, data about your participation in courses, and data from third-party platforms you connect with deltaFox. We also collect some data automatically, like information about your device and what parts of our Services you interact with or spend time using.</p>
              </div>
            </div>
